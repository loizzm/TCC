...
| G3b.4 | Latência do extrator clássico | < 200 ms | mediana 14.2 ms, p95 37.0 ms | ✅ |
...
| 2.8 | Latência por imagem | < 500 ms | mediana 854 ms, p95 2266 ms | ❌ |
| 2.6-aceitas | Amostras comparáveis (mesma ordem, ambos convergem) | diagnóstico | 188/300 | ❓ |
| 2.6[K] | ΔMAPE — K | ≤ 3 p.p. | +0.25 p.p. (oráculo 0.12%, real 0.36%) | ✅ |
| 2.6[tau] | ΔMAPE — tau | ≤ 3 p.p. | +0.54 p.p. (oráculo 0.33%, real 0.86%) | ✅ |
| 2.6[theta] | ΔMAPE — theta | ≤ 3 p.p. | +0.27 p.p. (oráculo 0.08%, real 0.35%) | ✅ |
| 2.6[wn] | ΔMAPE — wn | ≤ 3 p.p. | +0.82 p.p. (oráculo 0.80%, real 1.62%) | ✅ |
| 2.6[zeta] | ΔMAPE — zeta | ≤ 3 p.p. | +1.05 p.p. (oráculo 1.19%, real 2.24%) | ✅ |
| 2.6 | Degradação end-to-end (pior parâmetro) | ≤ 3 p.p. | +1.05 p.p. (n=188) | ✅ |
