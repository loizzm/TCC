...
| G3b.4 | Latência do extrator clássico | < 200 ms | mediana 13.4 ms, p95 36.5 ms | ✅ |
...
| 2.2-piso | Polilinha vs. máscara VERDADEIRA (perpendicular) | RMSE ≤ 1.0 px, p95 ≤ 2.0 px | RMSE=0.614 px, p95=1.135 px (n=300) | ✅ |
...
| 2.1 | Erro perpendicular da máscara (U-Net) | ≤ 1.0 px mediana, ≤ 2.0 px p95 | 0.800 px / 1.699 px (n=300) | ✅ |
...
| 2.7[legenda=False] | Erro perpendicular — legenda=False | ≤ 1.0 px mediana | 0.792 px (n=155) | ✅ |
...
| 2.7[traco=-] | Erro perpendicular — traco=- | ≤ 1.0 px mediana | 0.680 px (n=94) | ✅ |
...
| 2.8 | Latência por imagem | < 500 ms | mediana 176 ms, p95 261 ms | ✅ |
