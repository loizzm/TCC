...
| **1.7** | Tempo de geração extrapolado para 6000 amostras | < 15 min (folga 2× sobre os 30 min do PLANO) | 2.15 s para 200 amostras ⇒ 1.07 min | **PASSA** |
...
|---|---|---|---|---|---|
| 200 | 16 | 2.15 | 0.0107 | **1.07** | < 15 min (folga 2× sobre os 30 min do PLANO) |
